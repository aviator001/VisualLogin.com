...
a:hover { 
    text-decoration:none;
			...
			<script type="text/javascript" src="assets/js/search_bar.js"></script>

			<script type="text/javaScript" src="assets/js/flash_stream.js"></script> 
			...
			<script type="text/javascript" src="assets/js/magic_box.js"></script>
		...
		<div id="cam1"  class="www_box5" style="width:240px;height:170px;background:#f0f0f0;padding-top:25px;padding-left:7px;padding-right:7px;right:25px;position:absolute;display:none;z-index:9999999999999999999999999"></div>
			...
			<div id="wrapper" class="www_wrapper" style="background:;top:10px;box-shadow:5px 0px 50px rgba(0,0,0,0.8);border-radius:0px;overflow-x:hidden;b.jpg;overflow-y:hidden;height:728px">
		...
		<div class="col-md-12">
			<table style="width:100%">
				<tr>
					...
					<td style="width:50%">
						<div style="position:absolute;z-index:0;left:0;right:0;margin:auto;margin-top:-30px;width:100px;cursor:hand;cursor:pointer" id="magic_box"></div>
						<div onclick="pattern()" id="pattern_logo" >
						</div>
					</td>
					<td style="width:25%">
						<div style="text-align:center"><input type="button" name="forgot_button" id="forgot_button" class="btn btn-danger pull-right" onclick="send_password_new()" value="Forgot"></div>
					</td>
				</tr>
			</table>
		</div>
...
<br><br><a href="#" onclick="pattern()">Pattern</a>
</div>
		...
		<strong>E-mail Address</strong> not found!
			...
			<label>E-mail Address OR Mobile Number</label>
                <form class="input-group" method="post" action="#">
                    ...
                    <button class="btn btn-primary" onclick="send_password_new()">SEND</button>
                    </span>
                </form>
			</div>
		</div>
